...
import { startOrAccessNodeA, NODE_1_WS_ENDPOINT, NODE_1_HTTP_ENDPOINT, dummyDataTestConfig, userPassword } from "./utils.js"
...
describe("Same-node behavior", () => {
  before(async () => {
    ...
    samaClientB = new SAMAClient(configNodeA)
    samaClientB.deviceId = v4()

    dummyDataTestConfig.conversations.group.nativeId
